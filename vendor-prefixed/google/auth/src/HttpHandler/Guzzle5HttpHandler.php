...
use Mihdan\ReCrawler\Dependencies\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!\class_exists('Mihdan\\ReCrawler\\Dependencies\\GuzzleHttp\\Promise\\Promise')) {
