...
namespace Mihdan\ReCrawler\Dependencies\Psr\Log\Test;

use Mihdan\ReCrawler\Dependencies\Psr\Log\LoggerInterface;
use Mihdan\ReCrawler\Dependencies\Psr\Log\LogLevel;
use Mihdan\ReCrawler\Dependencies\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('Mihdan\\ReCrawler\\Dependencies\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('Mihdan\\ReCrawler\\Dependencies\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('Mihdan\\ReCrawler\\Dependencies\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
